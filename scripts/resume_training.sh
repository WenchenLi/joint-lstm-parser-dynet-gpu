...
build/parser/lstm-parse -T $TRAIN_DATA -d $DEV_DATA --model $MODEL -w $WORD_EMBEDDING --propbank_lemmas $TRAIN_CONLL_LEMMA  -g $DEV_CONLL_DATA -e eval09.pl -s dev.wang.predictions.conll -t > train.log